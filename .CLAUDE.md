...
1. **Verify first** - read files, check docs (context7/WebSearch), run non-destructive commands
...
❌ Wrong: "This might not support X, let me try another approach..."
   (assumes → acts)

✅ Right: "I'm unsure if this supports X. Should I check the docs/source first, or do you know?"
   (states uncertainty → asks)
