...
Brand templates for reference and testing.

## TrendLife Template

**File:** `1201_TrendLife PowerPoint Deck.pptx` (17 MB)
...
- **Logo Location:** `ppt/media/image3.png` (TrendLife logo with tagline)

**Note:** This file is for reference only. Do not modify the original template.

---

## Future Templates

**TrendAI Template:** To be added when available
