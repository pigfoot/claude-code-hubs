...
The system SHALL convert ADF to Markdown suitable for Claude editing,
with Confluence-specific elements represented as round-trippable markers
instead of lossy placeholders.
...
The system SHALL upload Markdown files (with custom markers) to Confluence
by converting to ADF JSON and using the v2 REST API.
