...
### Prompt Template
[Template with color injection]

### Logo Configuration
[Asset paths and positioning rules]

### Style Guidelines
[Design principles and best practices]
```

**Rationale:** Centralized documentation ensures consistency and enables future style additions (e.g., TrendAI).
